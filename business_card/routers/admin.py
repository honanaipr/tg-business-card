...
from aiogram.types import (ChosenInlineResult, InlineKeyboardButton,
...
async def command_start_handler(message: Message, command: CommandObject, dialog_manager: DialogManager, state: FSMContext):
    if not utils.is_admin(message.from_user.id):
