...
secondary_diolog = Dialog(
    Window(
        ...
        Row(
            SwitchTo(id="btn_help", text=Const("Second"), state=SecondarySG.second),
    ...
    Window(
        StaticMedia(url=Const(get_placeholder_image_url(text="Secondary second window")), type=ContentType.PHOTO),
        SwitchTo(id="btn_main", text=Const("Back"), state=SecondarySG.first),
        state=SecondarySG.second
    ),
    Window(
        StaticMedia(url=Const(get_placeholder_image_url(text="Secondary third window")), type=ContentType.PHOTO),
        SwitchTo(id="btn_main", text=Const("Back"), state=SecondarySG.first),
