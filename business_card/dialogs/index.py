...
index_dialog = Dialog(  # type: ignore
    Window(
        ...
        Row(
            SwitchTo(
                id="btn_start_services",
                state=MainSG.services,
                text=Const("🛠️ Services"),
            ),
        ),
        Row(
            SwitchTo(id="btn_help", text=Const("📃❓ Help"), state=MainSG.help),
            SwitchTo(
                id="btn_settings", text=Const("⚙️ Settings"), state=MainSG.settings
            ),
        ),
        Start(
    ...
    Window(
        StaticMedia(
            url=Const(get_placeholder_image_url(text="Services")),
            type=ContentType.PHOTO,
        ),
        Const("Здесь находятся бесплатные сервисы"),
        Group(
            Start(
                id="btn_translate", text=Const("🌍💬 Transalte"), state=TranslateSG.main
            ),
            Start(
                id="btn_translate", text=Const("🌍💬 Transalte"), state=TranslateSG.main
            ),
    ...
    Window(
        StaticMedia(
            url=Const(get_placeholder_image_url(text="Help")), type=ContentType.PHOTO
        ),
        Const(
            "Этот бот умеет несколько прикольных вещей.\n /start - перезапустите бота, если у вас возникли трудности."
        ),
        SwitchTo(id="btn_main", text=Const("↩️ Main menu"), state=MainSG.main),
        state=MainSG.help,
    ),
    Window(
        StaticMedia(
            url=Const(get_placeholder_image_url(text="Settings window")),
            type=ContentType.PHOTO,
        ),
